...
Parti Room 的发布流程应保持简单。对于快速开发的小游戏，发布前最重要的是：产物正确、能导入、能实际试玩，并准备好正式上线所需的封面。
...
**正式上线必须提供封面。** 开发预览阶段可以暂时没有，但进入公开发布、市场或正式分发前必须补齐。
...
- 复杂封面可以使用生图工具生成；
- 复杂封面最终使用 JPG 格式；
- **JPG 封面文件大小必须不超过 200 KB**；
- 不使用空白占位图或临时开发截图作为正式封面。

封面的视觉效果由开发者 / 玩家判断即可，不要求 AI 做自动视觉评分或截图验收。
...
- [ ] 开发者或玩家实际试玩过核心流程；
- [ ] 正式上线版本已经提供封面；
- [ ] 简单封面可使用 SVG；复杂封面使用 JPG；
- [ ] JPG 封面文件大小不超过 200 KB。
